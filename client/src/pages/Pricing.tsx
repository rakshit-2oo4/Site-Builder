...
const Pricing = () => {
  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80hv]">
        <div className="text-center mt-16">
          <h2 className="text-gray-100 text-3xl font-medium">Choose Your Plane</h2>
        ...
        <span className="text-white"> Creation / Revision</span> consume <span className="text-white">5 credits </span>.
